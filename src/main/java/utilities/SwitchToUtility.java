...
public class SwitchToUtility extends Utility {
    ...
    // WebDriver.TargetLocator Selenium’un
    // “context switch” işlemlerini (alert, frame, window geçişi) yapan sınıf
    ...
    public static String getAlertText() {
        ...
        // Burada  getText WebElementin degil Alert interfaceinin
